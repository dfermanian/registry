class DonationsController < ApplicationController
  ...
  def paypal_response
    ...
    @donation.save
    if @donation.submit_donation
      UserMailer.deliver_profile(current_user.facebook_session.user,current_user.facebook_session.user, "I just made a donation! http://apps.facebook.com/ptndlol/")
